...
export default function LandingPage() {
  ...
  const dashStats = [
    ...
    },
    {
      icon: '🐔',
      label: 'Live Birds',
      value: liveStats ? liveStats.totalActiveBirds.toLocaleString() : '—',
      color: 'bg-emerald-50'
    },
    {
      icon: '💰',
      label: 'Revenue',
      value: liveStats ? `₦${liveStats.revenueThisMonth.toLocaleString()}` : '—',
      color: 'bg-sky-50'
    },
    {
      icon: '👷',
      label: 'Workers',
      value: liveStats ? liveStats.totalWorkers.toLocaleString() : '—',
      color: 'bg-violet-50'
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          ...
          <motion.div initial={{ opacity: 0, y: 36 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="overflow-hidden rounded-[1.5rem] border border-slate-100">
              <div className="flex items-center justify-between bg-emerald-700 px-5 py-4">
      ...
      <section className="bg-gradient-to-br from-emerald-700 to-emerald-900 px-4 sm:px-6 py-20 sm:py-24">
        <div className="mx-auto max-w-6xl text-center">
          <h2 className="text-3xl font-black tracking-tight text-white sm:text-4xl">Why FarmTrack?</h2>
