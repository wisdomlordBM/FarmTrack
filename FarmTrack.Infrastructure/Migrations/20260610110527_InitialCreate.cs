        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BirdType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TotalBirds = table.Column<int>(type: "int", nullable: false),
                    AliveBirds = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CratesSold = table.Column<int>(type: "int", nullable: false),
                    EggsPerCrate = table.Column<int>(type: "int", nullable: false),
                    PricePerCrate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCollected = table.Column<int>(type: "int", nullable: false),
                    CrackedEggs = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlockId = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NumberDied = table.Column<int>(type: "int", nullable: false),
